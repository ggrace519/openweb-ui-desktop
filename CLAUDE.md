...
Electron 39 + Svelte 5 shell around Open WebUI. Local install (bundled CPython/`uv`), optional llama.cpp, optional Open Terminal, remote connections as `<webview>` guests.
